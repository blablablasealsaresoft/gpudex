# ULTIMATE GPUDx DOCKER FIX SCRIPT - CLEAN VERSION
...
foreach ($file in $testFiles) {
    ...
    try {
        ...
        Write-Host "  SUCCESS $file - Status: $statusCode" -ForegroundColor Green
    } catch {
...
try {
    ...
    $mainStatus = $mainPage.StatusCode
    Write-Host "SUCCESS Main page loaded - Status: $mainStatus" -ForegroundColor Green
